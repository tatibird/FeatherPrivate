...
game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Ln3242/Feather-Client/main/mainscript.lua'))()")
    end
end)
...
elseif placeid == 6872265039 then
    if betterisfile("Feather-Client/Modules/6872265039.lua") then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Ln3242/Feather-Client/main/Modules/6872265039.lua"))()
    end
elseif placeid == 4282985734 then
    if betterisfile("Feather-Client/Modules/4282985734.lua") then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Ln3242/Feather-Client/main/Modules/Key.lua"))()
    end
elseif placeid == 11640391378 then
    if betterisfile("Feather-Client/Modules/11640391378.lua") then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Ln3242/Feather-Client/main/Modules/11640391378.lua"))()
    end
else
    if betterisfile("Feather-Client/Modules/Universal.lua") then
        loadstring(readfile("Feather-Client/Modules/Universal.lua"))()
    else
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Ln3242/Feather-Client/main/Modules/Universal.lua"))()
    end
end
